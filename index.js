...
console.log(
  chalk.bold.hex("#001CCF")(`${title.title.toUpperCase()}`) +
    chalk.bold.hex("#F7FFFB")(" : ")
);
  ...
  let confirm = await inquirer.prompt([
    {
      type: "confirm",
      name: "update",
      message: chalk.bold.hex("#00FFAE")(
        "Do you Want to update OR change your list item ?"
      ),
      default: "fasle",
    },
  ]);
  ...
  if (conditions == true) {
    ...
    switch (taskCheck.check) {
      ...
      case "UpdateItem":
        ...
        let b = todos.splice(
          todos.indexOf(updateList.update),
          1,
